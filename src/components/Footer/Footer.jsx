                ...
                <div className="container-xs mb-1.5 flex justify-between md:px-5 w-full">
                    ...
                    <div className="w-[30%] flex flex-col items-start sm:w-full pl-[120px]">
                        <ul>
                            ...
                            <li>
                                <a href="Galeri" target="_blank" rel="noreferrer" className="mt-[30px]">
                            ...
                            <li>
                                <a href="Trending" target="_blank" rel="noreferrer" className="mt-5">
                                    <Text as="p" className="text-[18px] font-normal text-blk">
                                        Trending
                                    </Text>
                                </a>
                    ...
                    <div className="flex flex-col items-center justify-center">
                        <ul>
                            <li>
                                <a href="#">
                                    <Text as="p" className="text-[18px] font-bold text-blk whitespace-nowrap">
                                        Temukan Kami di
                                    </Text>
                                </a>
                            </li>
